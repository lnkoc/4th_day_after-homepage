...
// pełne logowanie i ustanawianie sesji

function login() {

    const passmd5 = MD5(loginData.pass)

            axios.get('/getToken', { params: {
                    login: loginData.nickName,
                    pass: passmd5
                } }, 
            { withCredentials: true }
            ...
            .then((res) => {
                ...
                store.set(res.data)  // ustanownienie sesji w store
...
// opóźnienie między kolejnymi próbami logowania ;)
...
<template>
    <form class="loginForm">
        <fieldset>
            ...
            <br><br>
            <button class="myButton" @click.prevent="preLogin">Zaloguj</button>
        </fieldset>
    </form>
    <div class="hint">
        {{response}}
